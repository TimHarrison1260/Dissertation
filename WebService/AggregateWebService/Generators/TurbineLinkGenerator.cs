...
{
    /// <summary>
    /// Class <c>TurbineLinkGenerator</c> has the responsibility
    /// to generate the Turbine Hypermedia Links for the aggregate 
    /// entry being returned through the web service.
    /// </summary>
    public class TurbineLinkGenerator : ITurbineLinkGenerator
    {
        /// <summary>
